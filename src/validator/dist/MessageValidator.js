...
var MessageValidator = /** @class */ (function () {
    ...
    MessageValidator.sendMessage = function () {
        var _this = this;
        var userRepository = data_source_1.AppDataSource.getRepository(User_1.User);
        return [
            express_validator_1.body("receiver_id", "Please enter valid id")
                .isNumeric()
                .custom(function (receiver_id, _a) {
                var req = _a.req;
            ...
            express_validator_1.body("message", "Please enter a message").isAlphanumeric()
        ];
    };
    MessageValidator.sendGroupMessage = function () {
        var _this = this;
        var groupRepository = data_source_1.AppDataSource.getRepository(Friends_1.Group);
        var userRepository = data_source_1.AppDataSource.getRepository(User_1.User);
        return [
            express_validator_1.body("group_id", "Invalid group id")
                .isNumeric()
                .custom(function (groud_id, _a) {
                var req = _a.req;
                return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, groupRepository.findOneBy({
                                    id: groud_id
                                }).then(function (group) {
                                    if (group) {
                                        return true;
